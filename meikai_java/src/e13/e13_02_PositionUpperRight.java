 ...
 * @since 20191113
 */
public class e13_02_PositionUpperRight extends e13_02_RightTriangle {
	// 右上が直角の二等辺三角形を生成するコンストラクタ
	public e13_02_PositionUpperRight(int length, int anglePosition){
